...
const quickLinks = [
  ...
  { label: "About Us",               href: "/explore/southfork-roofing", external: false },
...
const socials: { icon: string; href: string; label: string }[] = [
  // [TODO: Add South Fork Roofing Facebook URL]
  // { icon: "icon-facebook", href: "https://www.facebook.com/southforkroofing", label: "Facebook" },
  // [TODO: Add South Fork Roofing YouTube URL if available]
];
    ...
    <footer ref={ref} className={`footer wow${vis}`}>
      ...
      <div className="inner inner--slim-1162">
        ...
        <div className={`footer__logo fadeInUpS wow${vis}`}>
          <a href="/">
            <span className="sr-only">South Fork Roofing and Chimney</span>
            {/* [TODO: Replace with South Fork Roofing logo] */}
            <img
              src="/logos/logo-long.svg"
              alt="South Fork Roofing and Chimney"
              width="220"
              height="48"
            />
          </a>
        ...
        <div className="footer__widgets">
          ...
          >
            ...
            <div className="content-entry">
              <p>
                ...
                <strong>(631) 527-6834</strong><br />
                southforkroofingandchimney@gmail.com<br />
          ...
          >
            ...
            <div className="content-entry">
              <p>
                East Hampton &bull; Southampton &bull; Bridgehampton<br />
                Hampton Bays &bull; Amagansett &bull; Montauk<br />
      ...
      <div className="inner">
        <div className={`footer__bottom cleared fadeInUpS wow${vis}`}>
          ...
          <div className="footer__bottom__left">
            &copy;2026 South Fork Roofing and Chimney. All rights reserved.
          </div>
