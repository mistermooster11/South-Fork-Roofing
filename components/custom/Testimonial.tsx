...
const testimonials = [
  ...
  },
  {
    id: "eli-douglas",
    quote:
      "I was very pleased with South Fork Roofing and Chimney. From start to finish they did a wonderful job. In all my years I have not been treated better. I will certainly recommend Tony and his company. My new roof looks great.",
    name: "Eli Douglas",
    position: "East Hampton Homeowner",
    platform: "Google Review ★★★★★",
  },
  {
    id: "maverick-barrett",
    quote:
      "Had a roof leak and Tony was dispatched to come and repair the leak. He came the next day after I submitted the request. Found the ice dam that was causing the leak and had it fixed in a short time.",
    name: "Maverick Barrett",
    position: "Long Island Homeowner",
    platform: "Google Review ★★★★★",
  },
  {
    id: "bailey-lewis",
    quote:
      "Blair worked diligently with insurance to get all repairs covered. The roof repair performed was done quickly and perfectly. Thanks.",
    name: "Bailey Lewis",
    position: "Hamptons Property Owner",
    platform: "Google Review ★★★★★",
  },
  {
    id: "liam-morgan",
    quote:
      "Tony and his crew did a total tear-off for my shingle roof and the flat roof. They were professional, did a wonderful job, and cleaned up after work was completed.",
    name: "Liam Morgan",
    position: "Long Island Homeowner",
    platform: "Google Review ★★★★★",
  },
  ...
  return (
    <div ref={ref} className="front-testimonial ia-bg-dark">
      <div className="inner inner--slim-1172">
        ...
        >
          Real Reviews From Hamptons Homeowners
        </h2>
      </div>
