    ...
    >
      <div className="accordion-item-in">
        ...
        >
          ...
          <p
            className="p3"
            style={{ color: '#27282A', marginBottom: '1rem', lineHeight: 1.6 }}
          >
            {item.description}
          </p>
          ...
          <div className="mob-version" style={{ marginTop: '2rem' }}>
            <p style={{ fontWeight: 700, marginBottom: '1rem', color: '#27282A' }}>
              How We Handle It
            </p>
            {item.steps.map((step, i) => (
              <p key={i} className="p3" style={{ marginBottom: '0.75rem', color: '#27282A' }}>
