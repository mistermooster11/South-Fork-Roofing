        ...
        <div className="inner inner--slim-1172 cleared">
          <div className="hero-org-in">
            ...
            <div className="hero-org__text">
              ...
              >
                <p>
                  From storm damage repairs to full roof replacements, South Fork Roofing and Chimney
                  handles every roofing and exterior job across The Hamptons and Long Island. Free
                  estimates, licensed and insured, available 24/7.
                </p>
              </div>
            </div>
