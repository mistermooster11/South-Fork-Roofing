      ...
      <div className="inner overflow-visible relative">
        <div className="max-w-8xl max-[767px]:pl-10">
         ...
         <div className='relative z-20'>
          ...
          >
            The Hamptons&apos; Trusted Roofing &amp; Chimney Specialists Since 1985
          </h1>
          ...
          <div className="flex justify-start pb-20 max-[767px]:block max-[767px]:pb-8">
            ...
            >
              <p className="text-[1.9rem] leading-[1.6]">
                Roofing repairs and replacements, chimney repair &amp; rebuilds, siding, skylights,
                and gutters — serving East Hampton, Southampton, and all of Long Island.
